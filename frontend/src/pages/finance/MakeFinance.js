...
const SelectFinance = () => {
  ...
  const handlemakeProduct = () => {
    ...
    dispatch(makeProduct(finance)).then((resultAction) => {
  ...
  return (
    <div className="make-product-container">
      ...
      <div className="title-info-set">
        <label htmlFor="productTitle">상품 이름</label>
        <br />
        <input
          id="productTitle"
          type="text"
      ...
      <div className="title-info-set">
        <label htmlFor="productPeriod">계약 기간 ( 개월 )</label>
        <br />
        <input
          id="productPeriod"
          type="number"
      ...
      <div className="title-info-set">
        <label htmlFor="productRate">{productRateName}이자율 ( % )</label>
        <br />
        <input
          id="productRate"
          type="number"
      ...
      <div className="selectfinance-footer">
        <Footer />
      </div>
    </div>
  );
